...
This exercise tests your database decision-making — the type of question that appears
3–5 times on the ACE exam. Run the interactive quiz script, pick an answer for each
scenario, and get immediate feedback with an explanation:
