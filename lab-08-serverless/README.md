...
The application source is in the `cloudsql-demo/` directory of this repository.
Deploy it with the Cloud SQL connection configured. The `--add-cloudsql-instances`
flag tells Cloud Run to mount the Cloud SQL Auth Proxy socket:
